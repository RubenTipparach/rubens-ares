...
struct RDP : Thread, Memory::RCP<RDP> {
  ...
  //render.cpp
  auto render() -> void;
  auto writePixel(u32 x, u32 y, u32 color) -> void;
  auto readPixel(u32 x, u32 y) -> u32;
  auto fetchTexel(u32 tileIdx, s32 s, s32 t) -> u32;
  auto renderTriangle(bool shade, bool texture, bool zbuffer) -> void;
  auto colorCombine(u32 cycle, u8 texR, u8 texG, u8 texB, u8 texA,
  ...
  // Tile descriptor storage (8 tiles)
  struct TileDescriptor {
    n3 format;
    n2 size;
    n9 line;
    n9 address;  // TMEM address in 8-byte units
    n4 palette;
    struct {
      n1 clamp;
      n1 mirror;
